...
{
    public class SalesOrderReturnViewModel : ViewModelBase
    {
        ...
        public SalesOrderReturnViewModel()
        {
            InitialCommand();
        }

        public SalesOrderReturnViewModel(bool isList)
            : base()
        {
            this.IsSearchMode = isList;
        }
