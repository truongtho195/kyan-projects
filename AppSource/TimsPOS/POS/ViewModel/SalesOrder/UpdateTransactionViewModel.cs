...
namespace CPC.POS.ViewModel
{
    class UpdateTransactionViewModel : ViewModelBase
    {
        ...
        //Respository
        base_ProductRepository _productRepository = new base_ProductRepository();
        ...
        public UpdateTransactionViewModel(base_ProductModel productModel)
        {
            ...
            base_Department category = _departmentRepository.Get(x => x.LevelId == Define.ProductCategoryLevel && x.Id == productModel.ProductCategoryId);
            if (category != null)
