...
using System.Globalization;
    ...
    public class CServerSocket
    {
       ...
       /// </summary>
        ...
        public bool ReadyConnected
        {
            get {
                return mainSocket.IsBound;
            }
        }
        #endregion
        ...
        /// <summary>
        /// Send a hex messageby connecting selected
        /// </summary>
        /// <param name="mens">Message</param>
        /// <param name="SocketIndex">Index of connection</param>
        public bool SendTextV42(string mens, int SocketIndex)
        {
        ...
        /// <summary>
        /// Send a array byte data
        /// </summary>
        /// <param name="a array byte">data</param>
        /// <param name="SocketIndex">Index of connection</param>
        public bool SendByte(byte[] byData, int SocketIndex)
        {
            if ((Clients.Count - 1) >= SocketIndex)
            {
                Socket workerSocket = (Socket)Clients[SocketIndex];
