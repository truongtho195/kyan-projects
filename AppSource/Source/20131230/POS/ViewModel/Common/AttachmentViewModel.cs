    ...
    class AttachmentViewModel : ViewModelBase
    {
        ...
        private void Open(base_AttachmentModel file)
        {
            ...
            catch (Win32Exception win32Exception)
            {
                ...
                {
                    _log4net.Error(string.Format("Message: {0}. Source: {1}", win32Exception.Message, win32Exception.Source));
                    Xceed.Wpf.Toolkit.MessageBox.Show(win32Exception.Message, Language.Warning, System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Warning);
                }
            }
            catch (Exception exception)
            {
        ...
        private void Scan()
        {
            ...
            {
                Xceed.Wpf.Toolkit.MessageBox.Show(Language.Text17);
            }
        }
