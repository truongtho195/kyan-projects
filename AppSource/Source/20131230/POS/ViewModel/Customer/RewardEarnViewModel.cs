...
namespace CPC.POS.ViewModel
{
    class RewardEarnViewModel : ViewModelBase
    {
        ...
        private base_GuestRewardRepository _guestRewardRespository = new base_GuestRewardRepository();
            ...
            : this()
        {
            ...
            foreach (base_GuestRewardModel guestRewardModel in guestRewardCollection)
            {
                ...
                guestReward.RewardAmount = rewardModel.RewardProgramText;
        ...
        private void OnIssueNewRewardCommandExecute(object param)
        {
            ...
            issueNewReward.RewardValueEarned = RewardProgram.RewardAmount;
            ...
            issueNewReward.ActivedDate = issueNewReward.EarnedDate.Value.AddDays(RewardProgram.RedemptionAfterDays);
            ...
            issueNewReward.RewardAmount = RewardProgram.RewardProgramText;
            issueNewReward.GuestId = GuestID;
            this.GuestRewardList.Add(issueNewReward);
            Total++;
            SelectedReward = issueNewReward;
        }
