    ...
    class PromotionAdvanceSearchViewModel : ViewModelBase
    {
        ...
        private Expression<Func<base_Promotion, bool>> CreatePredicateWithConditionSearch()
        {
            ...
            if (StartDate.HasValue && EndDate.HasValue)
            {
                ...
                predicate = predicate.And(x => (x.StartDate.HasValue && x.StartDate.Value >= StartDate.Value) &&
                    (x.EndDate.HasValue && x.EndDate.Value <= EndDate.Value));
            }
            ...
            else if (EndDate.HasValue)
            {
                ...
                predicate = predicate.And(x => x.EndDate.HasValue && x.EndDate.Value <= EndDate.Value);
            }
