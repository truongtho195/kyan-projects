...
namespace CPC.Service
{
    ...
    public interface IDialogService
    {
        ...
        /// </summary>
        ReadOnlyCollection<FrameworkElement> Views
        {
            get;
        }
        ...
        /// A nullable value of type bool that signifies how a window was closed by the user.
        /// </returns>
        bool? ShowDialog<T>(object ownerViewModel, object viewModel) where T : FrameworkElement;
        ...
        /// A nullable value of type bool that signifies how a window was closed by the user.
        /// </returns>
        bool? ShowDialog<T>(object ownerViewModel, object viewModel, string title) where T : FrameworkElement;
        ...
        bool? ShowDialog<T>(object ownerViewModel, object viewModel, string title, bool isShowMaximize, bool isShowMinimize, bool isShowClose) where T : FrameworkElement;
