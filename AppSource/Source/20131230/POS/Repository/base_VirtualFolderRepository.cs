...
namespace CPC.POS.Repository
{
    ...
    public partial class base_VirtualFolderRepository
    {
        ...
        {
            return UnitOfWork.GetAll<base_VirtualFolder>();
        }
        ...
        {
            return UnitOfWork.GetAll<base_VirtualFolder>(expression);
        }
        ...
        /// <summary>
        /// Take a few base_VirtualFolder in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of base_VirtualFolder to sort</typeparam>
        /// <param name="ignoreCount">Number of base_VirtualFolder will ignore.</param>
        /// <param name="takeCount">Number of base_VirtualFolder will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;base_VirtualFolder&gt; instance.</returns>
        public IList<base_VirtualFolder> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_VirtualFolder, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;base_VirtualFolder&gt; instance.</returns>
        public IList<base_VirtualFolder> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_VirtualFolder, TKey>> keySelector, Expression<Func<base_VirtualFolder, bool>> expression)
        {
