...
namespace CPC.POS.Repository
{
    ...
    public partial class base_SaleCommissionRepository
    {
        ...
        {
            return UnitOfWork.GetAll<base_SaleCommission>();
        }
        ...
        {
            return UnitOfWork.GetAll<base_SaleCommission>(expression);
        }
        ...
        /// <summary>
        /// Take a few base_SaleCommission in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of base_SaleCommission to sort</typeparam>
        /// <param name="ignoreCount">Number of base_SaleCommission will ignore.</param>
        /// <param name="takeCount">Number of base_SaleCommission will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;base_SaleCommission&gt; instance.</returns>
        public IList<base_SaleCommission> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_SaleCommission, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;base_SaleCommission&gt; instance.</returns>
        public IList<base_SaleCommission> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_SaleCommission, TKey>> keySelector, Expression<Func<base_SaleCommission, bool>> expression)
        {
