    ...
    class ChangePasswordViewModel : ViewModelBase
    {
        ...
        private void OnOkCommandExecute()
        {
            if (ResourceAccountModel.NewPassword.Equals(ResourceAccountModel.NewConfirmPassword))
            {
                ...
                {
                    Xceed.Wpf.Toolkit.MessageBox.Show("Old password is not match", "POS", MessageBoxButton.OK, MessageBoxImage.Warning);
                }
            }
            else
            {
                Xceed.Wpf.Toolkit.MessageBox.Show("Confirm password is not match", "POS", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
        }
