...
namespace System.Waf.Applications
{
    ...
    public abstract class ViewModel : DataModel
    {
        ...
        protected ViewModel(IView view, bool isChild)
        {
            ...
            //if (!isChild)
            //{
        //        (this.view as System.Windows.Controls.ContentControl).Loaded += new Windows.RoutedEventHandler(ViewModel_Loaded);

                
        //    //}
        //}

        //private void ViewModel_Loaded(object sender, Windows.RoutedEventArgs e)
        //{
