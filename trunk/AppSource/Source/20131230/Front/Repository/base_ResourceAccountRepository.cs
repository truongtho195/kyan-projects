...
namespace CPC.POS.Repository
{
    ...
    public partial class base_ResourceAccountRepository
    {
        ...
        {
            return UnitOfWork.GetAll<base_ResourceAccount>();
        }
        ...
        {
            return UnitOfWork.GetAll<base_ResourceAccount>(expression);
        }
        ...
        /// <summary>
        /// Take a few base_ResourceAccount in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of base_ResourceAccount to sort</typeparam>
        /// <param name="ignoreCount">Number of base_ResourceAccount will ignore.</param>
        /// <param name="takeCount">Number of base_ResourceAccount will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;base_ResourceAccount&gt; instance.</returns>
        public IList<base_ResourceAccount> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_ResourceAccount, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;base_ResourceAccount&gt; instance.</returns>
        public IList<base_ResourceAccount> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_ResourceAccount, TKey>> keySelector, Expression<Func<base_ResourceAccount, bool>> expression)
        {
