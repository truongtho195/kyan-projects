...
namespace CPC.POS.Repository
{
    ...
    public partial class base_PricingChangeRepository
    {
        ...
        {
            return UnitOfWork.GetAll<base_PricingChange>();
        }
        ...
        {
            return UnitOfWork.GetAll<base_PricingChange>(expression);
        }
        ...
        /// <summary>
        /// Take a few base_PricingChange in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of base_PricingChange to sort</typeparam>
        /// <param name="ignoreCount">Number of base_PricingChange will ignore.</param>
        /// <param name="takeCount">Number of base_PricingChange will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;base_PricingChange&gt; instance.</returns>
        public IList<base_PricingChange> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_PricingChange, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;base_PricingChange&gt; instance.</returns>
        public IList<base_PricingChange> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_PricingChange, TKey>> keySelector, Expression<Func<base_PricingChange, bool>> expression)
        {
