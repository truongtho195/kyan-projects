...
namespace CPC.POS.Database
{
    public class UnitOfWork : IDisposable
    {
        ...
        public UnitOfWork(string connectionString)
        {
            if (_objectContext == null)
            {
                _objectContext = new POSLicenseEntities(connectionString);

            }

        }

        public UnitOfWork(System.Data.EntityClient.EntityConnection entityConnection)
        {
            if (_objectContext == null)
            {
                _objectContext = new POSLicenseEntities(entityConnection);
            }
        ...
        public UnitOfWork()
        {
            if (_objectContext == null)
            {
                _objectContext = new POSLicenseEntities(ConfigurationManager.ConnectionStrings["POSLicenseEntities"].ConnectionString);
            }
        }
        ...
        public IEnumerable<T> GetIEnumerable<T>() where T : class
        {
        ...
        /// <param name="expression">A function to test each object for a condition.</param>
        /// <returns>The new IEnumerable<T> instance.</returns>
        public IEnumerable<T> GetIEnumerable<T>(Expression<Func<T, bool>> expression) where T : class
        {
        ...
        /// </returns>
        public IQueryable<T> GetIQueryable<T>(Expression<Func<T, bool>> expression) where T : class
        {
            return _objectContext.CreateObjectSet<T>().Where(expression);
        }
        ...
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRange<T>(int ignoreCount, int takeCount, string keys) where T : class
        {
        ...
        /// <param name="expression">A function to test each object for a condition.</param>
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRange<T>(int ignoreCount, int takeCount, string keys, Expression<Func<T, bool>> expression) where T : class
        {
        ...
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRange<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector) where T : class
        {
        ...
        /// <param name="expression">A function to test each object for a condition.</param>
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRange<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>> expression) where T : class
        {
        ...
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRangeDescending<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector) where T : class
        {
        ...
        /// <param name="expression">A function to test each object for a condition.</param>
        /// <returns>The new IList<T> instance.</returns>
        public IList<T> GetRangeDescending<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>> expression) where T : class
        {
        ...
        public void Refresh<T>(IEnumerable<T> entityCollection) where T : class
        {
        ...
        public bool TryGetObjectByKey<T>(string keyName, object keyValue, out object value) where T : class
        {
