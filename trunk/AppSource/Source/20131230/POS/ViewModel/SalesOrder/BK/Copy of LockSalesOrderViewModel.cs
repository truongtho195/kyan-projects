...
namespace CPC.POS.ViewModel
{
    public class LockSalesOrderViewModel : ViewModelBase
    {
        ...
        {
            MessageBoxResult msgResult = Xceed.Wpf.Toolkit.MessageBox.Show("Do you want to unlock this order?", "POS", MessageBoxButton.YesNo,MessageBoxImage.Warning,MessageBoxResult.Yes);
            if (msgResult.Is(MessageBoxResult.Yes))
            {
                UnLockSaleOrder();
        ...
        public override void LoadData()
        {
            ...
            predicate = predicate.And(x => x.OrderStatus != orderStatus && x.OrderStatus != layawayStatus);
