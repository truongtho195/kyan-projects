...
namespace CPC.POS.Repository
{
    ...
    public partial class base_UserLogDetailRepository
    {
        ...
        {
            return UnitOfWork.GetAll<base_UserLogDetail>();
        }
        ...
        {
            return UnitOfWork.GetAll<base_UserLogDetail>(expression);
        }
        ...
        /// <summary>
        /// Take a few base_UserLogDetail in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of base_UserLogDetail to sort</typeparam>
        /// <param name="ignoreCount">Number of base_UserLogDetail will ignore.</param>
        /// <param name="takeCount">Number of base_UserLogDetail will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;base_UserLogDetail&gt; instance.</returns>
        public IList<base_UserLogDetail> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_UserLogDetail, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;base_UserLogDetail&gt; instance.</returns>
        public IList<base_UserLogDetail> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<base_UserLogDetail, TKey>> keySelector, Expression<Func<base_UserLogDetail, bool>> expression)
        {
