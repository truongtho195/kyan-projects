...
namespace CPC.POS.Repository
{
    ...
    public partial class tims_WorkScheduleRepository
    {
        ...
        {
            return UnitOfWork.GetAll<tims_WorkSchedule>();
        }
        ...
        {
            return UnitOfWork.GetAll<tims_WorkSchedule>(expression);
        }
        ...
        /// <summary>
        /// Take a few tims_WorkSchedule in sequence was sorted by descending on server.
        /// </summary>
        /// <typeparam name="TKey">Type of tims_WorkSchedule to sort</typeparam>
        /// <param name="ignoreCount">Number of tims_WorkSchedule will ignore.</param>
        /// <param name="takeCount">Number of tims_WorkSchedule will take.</param>
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList&lt;tims_WorkSchedule&gt; instance.</returns>
        public IList<tims_WorkSchedule> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<tims_WorkSchedule, TKey>> keySelector)
        {
        ...
        /// <returns>The new IList&lt;tims_WorkSchedule&gt; instance.</returns>
        public IList<tims_WorkSchedule> GetRangeDescending<TKey>(int ignoreCount, int takeCount, Expression<Func<tims_WorkSchedule, TKey>> keySelector, Expression<Func<tims_WorkSchedule, bool>> expression)
        {
